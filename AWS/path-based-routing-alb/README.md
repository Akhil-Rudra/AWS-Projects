...
![VPC created](docs/images/01-vpc-created.png)
...
![Subnets created](docs/images/02-subnets-created.png)

## Step 3: Internet Gateway Attached

Created and attached an Internet Gateway named `path-routing-igw` to the VPC.

![Internet Gateway attached](docs/images/03-internet-gateway-attached.png)
...
![AWS target group healthy](docs/images/05-aws-target-healthy.png)

![Azure target group healthy](docs/images/06-azure-target-healthy.png)

![GCP target group healthy](docs/images/07-gcp-target-healthy.png)
...
![Listener rules](docs/images/04-listener-rules.png)
...
![AWS path test](docs/images/08-aws-test.png)
...
![Azure path test](docs/images/09-azure-test.png)
...
![GCP path test](docs/images/10-gcp-test.png)
